{include file="public/include/HtmlHeadSet_ja.tpl" htmlTitle="UploadTop" }
<br />
...
<br>
<form name="form1" method="post" action="?_mod=Denpyo&amp;_act=Confirm" enctype="multipart/form-data" >
    ...
    <table width="680" cellpadding=2 cellspacing=1>
      <tr>
        ...
        アップロードする</ br>ファイル</td>
        <td width="460">・１ファイル当たりの最大サイズ数は1MBです。</td>
      </tr>
      <tr>
        <td width="460" height="27">{$form.org_filename.html}
		<div class="error">{$form.org_filename.error}{$form.remark.error}</div>
	</td>
      </tr>
    </table>
    <br>
	...
	<td width="460" class="titleblock" >伝票{* $form.remark.html *}<div class="error">{* $form.remark.error *}</div><input type=hidden name=remark value="伝票">
	</tr>
   </table>
