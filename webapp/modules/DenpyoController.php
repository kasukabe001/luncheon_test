...
default:
    ...
    $this->tpl_name = 'public/Denpyo.tpl';
    break;
...
// case 'Insert':
	...
	$this->tpl_name = 'public/Registration_Error_ja.tpl';
	break;
    }
	...
	$sys_filename = "SYP" . $iso1 . $sys_num2 . "-" . $file_name; //同名対策
	...
	if(!is_dir($dir)) {
 	    $this->renderer->assign('error', "アップロード用ディレクトリがありません");
            $this->tpl_name = 'public/Denpyo_Complete.tpl';
	    break;
	}
...
$this->renderer->assign('bpshj', "伝票ファイルアップロード");
$this->renderer->assign('bpshe', "Denpyo");
